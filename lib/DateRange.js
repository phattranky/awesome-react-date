...
var DateRange = function (_Component) {
  ...
  _createClass(DateRange, [{
    ...
    key: 'renderCalendar',
    value: function renderCalendar(calendars, linkedCalendars, link, range, format, firstDayOfWeek, styles, minDate, maxDate, onlyClasses, classes, weekdaysFormat, monthsFormat, leftButton, rightButton) {
      var _calendars = [];
    ...
    value: function render() {
      ...
      var weekdaysFormat = _props.weekdaysFormat;
      var monthsFormat = _props.monthsFormat;
